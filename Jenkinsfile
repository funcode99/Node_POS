                        ...
                        sshPublisher(
                            publishers: [
                                sshPublisherDesc(
                                 ...
                                 transfers: [
                                        sshTransfer(
                                          execCommand: 'docker pull silverstack19/backend:c6368749f5e7893a0335a296c09bd0ff5ec53cb3; docker kill frontend; docker run -d --rm --name frontend -p 8080:80 silverstack19/backend:c6368749f5e7893a0335a296c09bd0ff5ec53cb3',
                                          execTimeout: 120000,
                                    )
                                ]
                            )
